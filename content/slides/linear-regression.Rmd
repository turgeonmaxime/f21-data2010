...
The second model (with age as a feature) performs slightly better.
...
```
  ...
  - This was a huge improvement: we reduced the RMSE by almost 50%.
...
```
  ...
  - It performs slightly worse, but the difference is minimal.
